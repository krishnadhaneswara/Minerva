            ...
            <div class="container-fluid">
                ...
                <div class="col-md-3">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Enrolled Class</h4>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped table-list-search">
                                    <thead>
                                      <th>Class Code</th>
                                    	<th>Class Name</th>
                                    	<th>News / Topic / Quiz / Assignment</th>
...
$show = mysql_query("SELECT a.enrollID, a.classID, a.fileDirS, a.fileNameS , b.className, b.fileDir, b.fileName FROM enrolled as a
...
while($data = mysql_fetch_array($show))
{
  $enrollID=$data['enrollID'];
	...
	echo "<td>".$id."</td>";
	echo "<td>".$name."</td>";
  echo "<td><a href='$data[fileDir]'>$data[fileName]</a></td>";
  echo "<td><a href='$data[fileDirS]'>$data[fileNameS]</a></td>";
	echo "<td>
	<a href=vCourse.php?classID=$id>View Topic</a>
	&nbsp|
  <a href=submitAssignment.php?enrollID=$enrollID> Submit Assignment</a>
	</td>";
	echo "</tr>";
}
?>
