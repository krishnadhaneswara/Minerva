            ...
            <div class="container-fluid">
                ...
                <div class="col-md-3">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Assignment List</h4>
                            </div>
...
$view = mysql_query("SELECT * FROM course WHERE lecturerID='".$_SESSION['lecturerID']."'");
while($data = mysql_fetch_array($view))
{
  ...
  echo "<td>".$fName."</td>";
  echo "<td>
	<a href = uploadAssignment.php?classID = $classID>Add/Change Assignment </a>
  &nbsp|
  <a href = vSubmit.php?classID = $classID>View Submitted</a>
	</td>";
	echo "</tr>";
}
?>
